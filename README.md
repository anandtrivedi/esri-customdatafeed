...
- Leaves the geometry format on **auto-detect** unless you override it, shows a **review summary** before creating, then **creates → starts → verifies** each service with a live query and prints its FeatureServer URL.
